...
QString kJsonFileDialogFilter(); ///< The Open/Save file dialog filter
QString kJsonCsvFileDialogFilter(); ///< The file format filter for the import file picker dialog.
