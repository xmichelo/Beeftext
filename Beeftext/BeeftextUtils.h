...
void reportInternalError(xmilib::DebugLog& debugLog, QString const& error, QWidget* parent = nullptr); ///< Report an internal error using a message box and write details in the log
