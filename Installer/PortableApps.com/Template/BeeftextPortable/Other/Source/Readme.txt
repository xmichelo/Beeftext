...
user in an INI file next to BeeftextPortable.exe called BeeftextPortable.ini.
...
copy AppNamePortable.ini from this directory to BeeftextPortable.ini next to
BeeftextPortable.exe. The options in the INI file are as follows:
